...
const AllRaffleTickets = () => {
  return (
    <CombinedHeader>
      <main className="adminPageMainCommon">
        <div className="d-flex align-items-center justify-content-between mb-3 flex-wrap">
          <h2 className="mb-0">Raffle Ticket</h2>
          <NavLink className="btnBlue btnEarnWith ms-3" to={"/"}>Add New Raffle Ticket</NavLink>
        </div>
                  ...
                  <Table bordered className="mb-0">
                    <thead>
                      <tr>
                        ...
                        <th className="bgDark">Raffle Ticket Name</th>
                        <th className="bgDark">Raffle Ticket Id</th>
                        <th className="bgDark">Ticket Generation Type</th>
                        <th className="bgDark">Winner Selection Type</th>
                        <th className="bgDark">Winner Raffle Ticket Id</th>
...
export default AllRaffleTickets;
