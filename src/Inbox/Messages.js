        ...
        <Col xxl={5} xl={5} lg={12} md={12}>
            ...
            <div className="row">
              ...
              <div className="col">
                <div className="details">
                  <div className="title">Personal Corner Long Term Contributor Reward</div>
          ...
          <div className="inboxDetails mb-2 d-block d-xl-none">
            <div className="heading">
              ...
              <div className="title">Personal Corner Coupon Claim: NFT2020 (10% Fixed Discount)</div>
            ...
            <div className="details">
              <p>Hey Murphy,</p>
              <p>Development Team have thoroughly gone through the front end created by you and the admin user flow, there are some additions required in the admin user flow when compared with front end and some designs are missing, Kindly find below details.
1. Add Badges in Player Info Card in Dashboard.
2. Live Feed missing on dashboard.
              </p>
              <div>
